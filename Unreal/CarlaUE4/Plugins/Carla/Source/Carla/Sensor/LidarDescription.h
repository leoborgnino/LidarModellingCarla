...
struct CARLA_API FLidarDescription
{
  ...
  /// Model angle of incidence in intensity calculation
  UPROPERTY(EditAnywhere)
  bool ModelAngleofIncidence = false;
  /// Model material in intensity calculation
  UPROPERTY(EditAnywhere)
  ...
  UPROPERTY(EditAnywhere)
  bool ShowDebugPoints = false; // Warning
  UPROPERTY(EditAnywhere)
  ...
  // *********************************** //
  // Transceptor General Configurations  //
  // *********************************** //
  UPROPERTY(EditAnywhere)
